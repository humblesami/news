...
from main_app.settings import SOCKET_SERVER_URL
socket_server = {
...
def generate_default_image(name):
    ...
    font_directory = curr_dir.replace('main_app', 'static/assets/fonts')
    ...
    img_path = directory.replace('main_app', 'media/profile') + pic_name
    img.save(img_path)
